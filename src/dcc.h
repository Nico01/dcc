...
size_t strSize(uint8_t *, char);                           // parser.c
...
COND_EXPR *idCondExpReg(uint8_t regi, uint32_t flg, LOCAL_ID *);
...
bool removeDefRegi(uint8_t, PICODE, int, LOCAL_ID *);
